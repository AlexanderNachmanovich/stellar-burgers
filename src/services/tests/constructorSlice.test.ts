...
describe('Тестирование экшенов конструктора', () => {
  test('Тест начального состояния конструктора', () => {
    expect(reducer(undefined, { type: 'unknown' })).toEqual(initialState);
  });

  test('Тест состояния добавления булочки', () => {
  ...
  test('Тест состояния добавления начинки', () => {
  ...
  test('Тест состояния удаления ингредиента', () => {
  ...
  test('Тест состояния изменения порядка ингредиентов', () => {
  ...
  test('Тест модального окна заказа', () => {
    const action = setOrderModalData(mockOrder);
    const state = reducer(initialState, action);
    expect(state.orderModalData).toEqual(mockOrder);
  });

  test('Тест очистки ингредиентов после закрытия модального окна', () => {
...
describe('Тестирование работы редьюсеров для createOrder', () => {
  test('Тест состояния createOrder.pending', () => {
  ...
  test('Тест состояния createOrder.rejected', () => {
  ...
  test('Тест состояния createOrder.fulfilled', () => {
